                    ...
                    <Carousel.Item>
                        <div className="news-page-item">
                            ...
                            <figure className="news-item">
                                ...
                                <figcaption className="news-name">
                                    <a href="https://youtu.be/vfmGSLLC4pE" target="_blank" rel="noreferrer">
                    ...
                    <Carousel.Item>
                        <div className="news-page-item">
                            ...
                            <figure className="news-item">
                                ...
                                <figcaption className="news-name">
                                    <a href="https://coastalvawind.com/partnerships/become-supplier.aspx" target="_blank" rel="noreferrer">
